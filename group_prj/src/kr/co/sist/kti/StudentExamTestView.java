...
public class StudentExamTestView extends JDialog {

	private JLabel jlblSubjectNameSet, jlblNameSet;
	private JTextArea jtaNo1TitleSet, jtaNo1OptionSet, jtaNo2TitleSet, jtaNo2OptionSet, jtaNo3TitleSet, jtaNo3OptionSet,
	...
	public StudentExamTestView(StudentExamPanel sep, String selectedExamName) {
		...
		// #. 이벤트 추가
		// #-1. 이벤트 객체 생성
		StudentExamTestEvt sete = new StudentExamTestEvt(this);
		// #-2. 컴포넌트에 이벤트 추가
	...
	public JTextArea getJtaNo1TitleSet() {
		return jtaNo1TitleSet;
	}
	...
	public JTextArea getJtaNo2TitleSet() {
		return jtaNo2TitleSet;
	}
	...
	public JTextArea getJtaNo3TitleSet() {
		return jtaNo3TitleSet;
	}
	...
	public JTextArea getJtaNo4TitleSet() {
		return jtaNo4TitleSet;
	}
	...
	public JTextArea getJtaNo5TitleSet() {
		return jtaNo5TitleSet;
	}
