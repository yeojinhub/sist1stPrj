...
public class AdminBoardCommentView extends JDialog {
	...
	private AdminAccountAdminAccountInfoVO aaVO;
	private AdminBoardVO vo;

	public AdminBoardCommentView(AdminBoardVO vo, AdminBoardEvt abe) {
		this.vo = vo;
		...
		jbtnApply.addActionListener(abe);
	...
	public AdminAccountAdminAccountInfoVO getIaVO() {
		return aaVO;
	}

	public AdminBoardVO getVo() {
		return vo;
	}
}
